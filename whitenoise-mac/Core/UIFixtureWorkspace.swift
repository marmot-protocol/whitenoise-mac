...
private enum UIFixtureWorkspace {
    ...
    private static func messageBody(index: Int, usesMarkdown: Bool, hasMedia: Bool) -> String {
        ...
        case 1:
            return "Longer fixture note: \(repeatedClause). It includes enough words to wrap across lines and exercise row height measurement in a dense transcript."
        case 2:
            return "Mention @fixture with punctuation, URLs like https://example.com/\(index), and stable timestamps."
        case 3:
